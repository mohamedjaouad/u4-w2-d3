...
public class Main {
    public static void main(String[] args) {
        ...
        List<Product> products = List.of(
                new Product("Libro Java", "Books", 120.0),
                new Product("Pannolini Pampers", "Baby", 30.0),
                new Product("Macchinina", "Boys", 50.0),
                new Product("Romanzo Fantasy", "Books", 80.0),
                new Product("Felpa Ragazzi", "Boys", 40.0)
        );


        List<Customer> customers = List.of(
                new Customer("Mario Rossi", 1),
                new Customer("Luca Bianchi", 2),
                new Customer("Anna Verdi", 2)
        );
